...
def main():
    """
    Runs the command-line calculator, accepting an expression as a command-line argument.
    ...
    # The expression is the first command-line argument (sys.argv[0] is the script name)
    ...
    try:
        ...
        print(e)
        sys.exit(1) # Exit with an error code on calculation error
    except Exception as e:
        # Catch any other unexpected errors
        print(f"An unexpected error occurred: {e}")
        sys.exit(1) # Exit with an error code on unexpected error
